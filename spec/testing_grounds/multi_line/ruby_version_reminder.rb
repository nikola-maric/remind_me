...
REMIND_ME: { ruby_version: '2.7.8', condition: :eq, message: 'Message 1'}
=end
=begin
 This should produce valid + condition met reminder (we are using that ruby version)
 REMIND_ME: { ruby_version: '2.7.8', condition: 'eq', message: 'Message 2'}
=end
=begin
 This should produce valid + condition met reminder (we are using that ruby version - condition is missing, defaults to eq)
 REMIND_ME: { ruby_version: '2.7.8', message: 'Message 3'}
=end
=begin
 This should produce valid + condition met reminder (we are using lower ruby version)
 REMIND_ME: { ruby_version: '2.8', 'condition' => 'lte', message: 'Message 4'}
=end
=begin
 This should produce valid + condition met reminder (we are using that ruby version)
 REMIND_ME: { ruby_version: '2.7.8', 'condition' => 'lte', message: 'Message 5'}
=end
=begin
...
=begin
 ...
 REMIND_ME: { ruby_version: '2.8', condition: :gte, message: 'Message 7'}
=end
=begin
 This should produce valid + condition met reminder (we are using that ruby version equal to or greater than that)
 REMIND_ME: { ruby_version: '2.7.8', condition: :gte, message: 'Message 8'}
=end
=begin
...
=begin
 ...
 REMIND_ME: { ruby_version: '2.8', condition: :lt, message: 'Message 10'}
=end
=begin
 This should produce valid + condition NOT met reminder (we are using that exact ruby version)
 REMIND_ME: { ruby_version: '2.7.8', condition: :lt, message: 'Message 11'}
=end
=begin
...
=begin
 ...
 REMIND_ME: { ruby_version: '2.8', 'condition' => 'gt', message: 'Message 13'}
=end
=begin
 This should produce valid + condition NOT met reminder (we are using lower ruby version)
 REMIND_ME: { ruby_version: '2.7.8', 'condition' => 'gt', message: 'Message 14'}
=end
=begin
